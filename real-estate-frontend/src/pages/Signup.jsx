...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2 bg-white antialiased selection:bg-slate-900 selection:text-white">
      ...
      {/* SECTION 1: FULL SCREEN AUTH FORM (Left side on desktop, Bottom on mobile) */}
      <div className="w-full h-full flex flex-col justify-center px-6 py-10 sm:py-14 sm:px-16 md:px-24 lg:px-20 xl:px-32 bg-white relative order-2 lg:order-1">
        
        {/* Container for absolute centering without structural constraints */}
        <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="space-y-2 sm:space-y-3 text-left">
            ...
            <p className="text-slate-500 text-xs sm:text-sm font-medium">
              Join HomeVerse today and start exploring elite properties.
            </p>
          </div>
      ...
      {/* SECTION 2: LUXURY VISUAL SIDE (Right side on desktop, Top banner on mobile) */}
      <div className="relative flex flex-col justify-between p-6 sm:p-10 lg:p-12 bg-slate-950 overflow-hidden h-60 sm:h-80 lg:h-full order-1 lg:order-2">
        ...
        <div className="relative z-10 text-white max-w-md hidden sm:block lg:block">
          ...
          <p className="text-slate-300 text-xs lg:text-sm leading-relaxed font-medium opacity-90 hidden lg:block">
            Join our exclusive network. Discover premium properties, coordinate with expert agents, and unlock your next global investment seamlessly.
          </p>
        </div>
      </div>
