...
const PropertyDetails = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#f6f7fb]">
      {/* ── Redesigned top bar: floating glass capsule instead of a flat full-width strip ── */}
      <div className="sticky top-0 z-40 pt-4 px-4 md:px-8 pb-3 bg-gradient-to-b from-[#f6f7fb] via-[#f6f7fb]/95 to-transparent">
        <div
          className="max-w-6xl mx-auto flex items-center justify-between gap-4 px-4 md:px-6 py-3 rounded-full"
          style={{
        ...
        >
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2.5 bg-[#111827] hover:bg-[#1f2937] active:scale-95 pl-3 pr-4 py-2.5 rounded-full text-[13px] font-bold text-white transition-all duration-300 group flex-shrink-0"
          >
            <span className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center transition-transform duration-200 group-hover:-translate-x-0.5">
          ...
          <div className="hidden md:flex items-center gap-2 text-slate-400 min-w-0">
            <span className="text-[11px] font-bold tracking-[0.2em] uppercase text-slate-300">HomeVerse</span>
            <span className="text-slate-300">/</span>
            <span className="text-[11px] font-bold tracking-[0.2em] uppercase text-slate-500 truncate max-w-[220px]">
              {property.title}
            </span>
          </div>

          <div className="flex items-center gap-2 flex-shrink-0">
            <span className="hidden lg:flex items-center gap-1.5 text-[12px] text-slate-400 font-medium bg-slate-50 border border-slate-100 px-3.5 py-2 rounded-full">
            ...
            >
              <svg
                className={`w-4 h-4 ${saved ? 'fill-rose-500 stroke-rose-500' : 'fill-none stroke-current'}`}
                viewBox="0 0 24 24"
                strokeWidth="2"
              >
